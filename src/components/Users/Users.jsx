    ...
    let usersElements = props.users.map ( u => {return(
        <div key = {u.userId}>
            <div className={styles.userCard}>
                <img className={styles.avatar} src={u.avatar} />
                <br />
                {u.name}, {u.address.city}
                <div>
                    {u.isFollowed
                        ? <button onClick={() => props.unFollowUser(u.userId)}> Unfollow </button>
                        : <button onClick={() => props.followUser(u.userId)}>   Follow   </button>}
                </div>
            </div>
        </div>
    )});
